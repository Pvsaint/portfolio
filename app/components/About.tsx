    ...
    <div className="min-h-screen bg-black text-white font-sans antialiased flex flex-col pt-16">
      <main className="grow py-16 px-4 md:px-8 max-w-7xl mx-auto w-full flex flex-col items-center">
        <div className="w-full max-w-4xl">
          <p className="text-sm md:text-lg font-light uppercase tracking-wider text-surface mb-4 text-center md:text-left">
            Who I Am
          </p>
          <h1 className="text-3xl md:text-6xl font-extrabold text-primary leading-tight mb-12 text-center md:text-left">
            ABOUT ME
          </h1>
          ...
          <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="md:w-2/3 space-y-6 text-lg text-gray-300 leading-relaxed">
              ...
              <p>
                ...
                <span className="text-accent-1 font-semibold">Runescard</span>{" "}
                and{" "}
                <span className="text-accent-2 font-semibold">Paystrata</span>,
                I have hands-on experience in building and scaling products from
            ...
            <div className="md:w-1/3">
              <h3 className="text-2xl font-bold text-white mb-6 border-b-4 border-surface pb-2 inline-block">
                Skills & Tech
              </h3>
